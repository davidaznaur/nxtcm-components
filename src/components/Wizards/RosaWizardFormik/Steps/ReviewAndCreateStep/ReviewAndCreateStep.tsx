...
import { ReviewAndCreateStepItem } from './components/ReviewAndCreateStepItem';
import { MachinePoolsReviewAndCreateStepItem } from './components/MachinepoolsReviewAndCreateStepItem';
import { useTranslation } from '../../../../../context/TranslationContext';
import { StepId } from '../../constants';

export const ReviewAndCreateStep = (props: any) => {
  ...
  return (
    <Section label={t('Review your ROSA cluster')}>
      ...
      <Split hasGutter>
        ...
        <SplitItem>
          <Button onClick={() => goToStepById(StepId.Details)} variant="link" isInline>
            {t(`Edit Step`)}
          </Button>
        </SplitItem>
      </Split>
      ...
      <Split hasGutter>
        ...
        <SplitItem>
          <Button onClick={() => goToStepById(StepId.RolesAndPolicies)} variant="link" isInline>
            {t(`Edit Step`)}
          </Button>
        </SplitItem>
      </Split>
      ...
      <Split hasGutter>
        ...
        <SplitItem>
          <Button onClick={() => goToStepById(StepId.Networking)} variant="link" isInline>
            {t(`Edit Step`)}
          </Button>
        </SplitItem>
      </Split>
      ...
      <Split>
        ...
        <SplitItem>
          <Button onClick={() => goToStepById(StepId.Encryption)} variant="link" isInline>
            {t(`Edit Step`)}
          </Button>
        </SplitItem>
      </Split>
      ...
      <Split>
        ...
        <SplitItem>
          <Button onClick={() => goToStepById(StepId.NetworkingOptional)} variant="link" isInline>
            {t(`Edit Step`)}
          </Button>
        </SplitItem>
      </Split>
      ...
      <Split>
        ...
        <SplitItem>
          <Button onClick={() => goToStepById(StepId.ClusterUpdates)} variant="link" isInline>
            {t(`Edit Step`)}
          </Button>
        </SplitItem>
      </Split>
